...
@suppress_err begin
    ...
    @named src = MassSource(ps = p1, Ts = T1, mdots = 50, zs = z)
    ...
    @named sink =  MassSink(ps = p5, Ts = T5, zs = z)
    ...
    eqs =   [
            ...
            connect(heatexchanger2.outport,sink.port)
            ] # Define connections

    systems=[src,separator1,compressor1,heatexchanger1,separator2,compressor2,heatexchanger2,sink] # Define system
    ...
    comp1_mw =  Molecular_Weight(model,sol[compressor1.z_out])
    ...
    hx1_mw =  Molecular_Weight(model,sol[heatexchanger1.z_out])
    ...
    comp2_mw =  Molecular_Weight(model,sol[compressor2.z_out])
    ...
    hx2_mw =  Molecular_Weight(model,sol[heatexchanger2.z_out])
