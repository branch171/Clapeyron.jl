...
#=
pin = 2.675e6
Tin = 262.95268347975997
zin = [0.9956705607781376, 0.004327124566055551, 2.314655806758025e-6]
pout = p_ambient
Tcrit = Tin - 20.0
Tout = Tin - 40.0
pcrit = 0.58*pin
...
flash = Clapeyron.tp_flash_impl(model,pin,Tin,zin, HELDTPFlash(verbose = true))
...
flow1,pcrit1,Tcrit1,Tout1 = orificeFlow(model,pin,Tin,zin,pcrit,Tcrit,pout,Tout,2.0*25.4/1000.0/sqrt(2),8.0*25.4/1000.0,0.67,0.98,true)
